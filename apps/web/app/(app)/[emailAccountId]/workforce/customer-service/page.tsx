...
const tabOptions = (emailAccountId: string) => [
  {
    id: "rules",
    label: "Rules",
    href: `/${emailAccountId}/workforce/customer-service?tab=rules`,
  },
  {
    id: "test",
    label: "Test",
    href: `/${emailAccountId}/workforce/customer-service?tab=test`,
  },
  {
    id: "history",
    label: "History",
    href: `/${emailAccountId}/workforce/customer-service?tab=history`,
  },
  {
    id: "settings",
    label: "Settings",
    href: `/${emailAccountId}/workforce/customer-service?tab=settings`,
  },
];
          ...
          <div className="flex items-center justify-between">
            <div>
              <PageHeader
                ...
                description="Your AI Assistant helps you manage emails, draft replies, and organize your inbox."
                video={{

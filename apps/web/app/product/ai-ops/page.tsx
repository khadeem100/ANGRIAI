    ...
    <div className="mx-auto max-w-7xl px-6 py-16 md:py-24">
      <section className="text-center">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-pretty text-base text-muted-foreground md:text-lg">
          Angri turns emails into actions across your stack. Create leads,
          quotes, invoices, tickets, and tasks automatically in tools like Odoo,
          QuickBooks, Stripe, Monday, Notion, HubSpot and more. Review drafts
          where it matters — or let it run on autopilot.
        </p>
        ...
        <p className="mt-6 text-xs text-muted-foreground">
          Connect: Odoo • QuickBooks • Stripe • Monday • Notion • HubSpot •
          Google • Microsoft • more coming soon
        </p>
      </section>
      ...
      <section className="mt-10">
        <div className="mx-auto grid max-w-5xl grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
          {[
            ...
            <div
              key={i.name}
              className="flex items-center justify-center rounded-lg border bg-card px-3 py-2 text-xs font-semibold text-muted-foreground"
            >
              {i.name}
            </div>
          ))}
      ...
      <section className="mt-20 rounded-2xl border bg-gradient-to-b from-background to-muted/30 p-8 text-center md:p-12">
        <h3 className="text-2xl font-semibold md:text-3xl">
          Let Angri run your back office
        </h3>
        <p className="mx-auto mt-2 max-w-2xl text-sm text-muted-foreground md:text-base">
          Connect your tools, tell it what to do, and watch admin work
          disappear. Start with approvals, then go autopilot.
        </p>

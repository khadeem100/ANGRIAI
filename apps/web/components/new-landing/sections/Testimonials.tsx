...
const stevenTestimonial: Testimonial = {
  body: "Love this new open-source app by TynkTech: tynktech.com",
  author: {
    name: "Steven Tey",
    handle: "Dub",
...
export function Testimonials() {
  return (
    <Section>
      <SectionHeading wrap>
        Sluit je aan bij {userCount} anderen die minder tijd aan e-mail besteden
      </SectionHeading>
      <SectionSubtitle>
        Onze klanten houden van tijd besparen met Angri.
      </SectionSubtitle>
      <SectionContent>
        {/* Mobile */}

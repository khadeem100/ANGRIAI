...
export function AuthPage() {
    ...
    useEffect(() => {
        if (error) {
            toast.error(error === "RequiresReconsent" ? "Please grant permissions to continue" : "Authentication failed. Please try again.");
        }
    }, [error]);
				...
				<div className="mx-auto space-y-4 sm:w-sm w-full max-w-sm">
					...
					<div className="flex flex-col space-y-1">
						...
						<p className="text-muted-foreground text-base">
							Log in or create your Angri account.
						</p>
					</div>
					...
					<form className="space-y-2" onSubmit={handleEmailSignIn}>
                        ...
                        <div className="relative h-max">
							...
							/>
							<div className="text-muted-foreground pointer-events-none absolute inset-y-0 start-0 flex items-center justify-center ps-3 peer-disabled:opacity-50">
                                {/* Using Grid2x2PlusIcon as placeholder for lock icon since it was imported, normally would use LockIcon */}

...
const Textarea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(
  ({ className, ...props }, ref) => (
    <textarea
      className={cn(
        "flex w-full rounded-md border-none bg-transparent px-3 py-2.5 text-base placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-0 disabled:cursor-not-allowed disabled:opacity-50 min-h-[44px] resize-none",
        className,
      )}
      ref={ref}
      rows={1}
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 grid w-full max-w-[90vw] md:max-w-[800px] translate-x-[-50%] translate-y-[-50%] gap-4 border bg-background p-0 shadow-xl duration-300 rounded-2xl",
        className,
      )}
      {...props}
    >
                  ...
                  <div className="w-5 h-5 flex items-center justify-center flex-shrink-0">
                    ...
                    >
                      <Globe
                        className={cn(
                          "w-4 h-4",
                          showSearch ? "text-blue-500" : "text-inherit",
                        )}
                      />
                    </motion.div>
                  </div>
                  ...
                  <div className="w-5 h-5 flex items-center justify-center flex-shrink-0">
                    ...
                    >
                      <BrainCog
                        className={cn(
                          "w-4 h-4",
                          showThink ? "text-purple-500" : "text-inherit",
                        )}
                      />
                    </motion.div>
                  </div>
                  ...
                  <div className="w-5 h-5 flex items-center justify-center flex-shrink-0">
                    ...
                    >
                      <FolderCode
                        className={cn(
                          "w-4 h-4",
                          showCanvas ? "text-orange-500" : "text-inherit",
                        )}
                      />
                    </motion.div>
                  </div>
